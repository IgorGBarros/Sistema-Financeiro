...
from core.authentication import USUARIO_DEV
from core.services.seed import criar_workspace_padrao
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **opcoes):
        ...
        if workspace is None:
            ...
            from core.services.seed import popular_plano_de_contas

            popular_plano_de_contas(workspace)
            self.stdout.write(f"Workspace existente: {workspace.nome}")

        from core.models import Categoria, Classificacao
